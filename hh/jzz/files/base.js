...
var fhtml='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="../download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0/#version=7,0,19,0/default.htm" name="'+adid+'" width="'+w+'" height="'+h+'" id="'+adid+'"><param name="movie" value="'+adSrc+'" /><param name="quality" value="high" />'+trans+'<embed src="'+adSrc+'" width="'+w+'" height="'+h+'" quality="high" '+pars+' pluginspage="../www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" name="'+adid+'" id="'+adid+'"></embed></object>';$(adDiv).innerHTML=fhtml;try{var fw=$(adid).GetVariable("../download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0/Stage.width")?$(adid).GetVariable("Stage.width"):$(adid).TGetProperty("_root",8);}catch(e){}
