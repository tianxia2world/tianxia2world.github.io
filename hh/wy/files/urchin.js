...
if (!_utcp || _utcp=="") _utcp="default.htm";
...
function _uInfo(page) {
 ...
 if (!_ur || _ur=="") { _ur="-"; }
  ...
  dm=_ubd.domain;
  if(_utcp && _utcp!="default.htm") dm+=_utcp;
  p=_ur.indexOf(dm);
  if ((p>=0) && (p<=8)) { _ur="0"; }
...
function _uVG() {
 if((_udn.indexOf("www.google.") == 0 || _udn.indexOf(".google.") == 0 || _udn.indexOf("google.") == 0) && _utcp=='default.htm' && _udn.indexOf("google.org")==-1) {
  return false;
 }
 return true;
}
